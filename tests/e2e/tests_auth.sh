...
# The server evaluates authentication middleware before resource lookup.
...
run_test "ZIG : OPENQA_API_KEY+SECRET env vars authenticate request" \
	"bash -c \"OPENQA_CONFIG=/tmp/wrongsecret OPENQA_API_KEY='$OPENQA_API_KEY' OPENQA_API_SECRET='$OPENQA_API_SECRET' \
